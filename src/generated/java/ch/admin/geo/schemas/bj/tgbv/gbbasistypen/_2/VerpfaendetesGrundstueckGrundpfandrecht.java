...
/**
 * <p>Java class for VerpfaendetesGrundstueckGrundpfandrechtType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="VerpfaendetesGrundstueckGrundpfandrechtType"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://schemas.geo.admin.ch/BJ/TGBV/GBBasisTypen/2.1}InhaltVerpfaendetesGrundstueckGrundpfandrecht" maxOccurs="unbounded"/&gt;
 *         &lt;element name="VerpfaendetesGrundstueck" type="{http://schemas.geo.admin.ch/BJ/TGBV/GBBasisId/2.1}GrundstueckNummer"/&gt;
...
@XmlType(name = "VerpfaendetesGrundstueckGrundpfandrechtType", propOrder = {
    "inhaltVerpfaendetesGrundstueckGrundpfandrechts",
    "verpfaendetesGrundstueck",
    "extensions"
})
@XmlRootElement(name = "VerpfaendetesGrundstueckGrundpfandrecht")
public class VerpfaendetesGrundstueckGrundpfandrecht {

    @XmlElement(name = "InhaltVerpfaendetesGrundstueckGrundpfandrecht", required = true)
    protected List<InhaltVerpfaendetesGrundstueckGrundpfandrecht> inhaltVerpfaendetesGrundstueckGrundpfandrechts;
    @XmlElement(name = "VerpfaendetesGrundstueck", required = true)
    @XmlJavaTypeAdapter(NormalizedStringAdapter.class)
    @XmlSchemaType(name = "normalizedString")
    protected String verpfaendetesGrundstueck;
    ...
    /**
     * Gets the value of the inhaltVerpfaendetesGrundstueckGrundpfandrechts property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the inhaltVerpfaendetesGrundstueckGrundpfandrechts property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getInhaltVerpfaendetesGrundstueckGrundpfandrechts().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link InhaltVerpfaendetesGrundstueckGrundpfandrecht }
     * 
     * 
     */
    public List<InhaltVerpfaendetesGrundstueckGrundpfandrecht> getInhaltVerpfaendetesGrundstueckGrundpfandrechts() {
        if (inhaltVerpfaendetesGrundstueckGrundpfandrechts == null) {
            inhaltVerpfaendetesGrundstueckGrundpfandrechts = new ArrayList<InhaltVerpfaendetesGrundstueckGrundpfandrecht>();
        }
        return this.inhaltVerpfaendetesGrundstueckGrundpfandrechts;
    }

    /**
     * Gets the value of the verpfaendetesGrundstueck property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getVerpfaendetesGrundstueck() {
        return verpfaendetesGrundstueck;
    }

    /**
     * Sets the value of the verpfaendetesGrundstueck property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setVerpfaendetesGrundstueck(String value) {
        this.verpfaendetesGrundstueck = value;
    }
