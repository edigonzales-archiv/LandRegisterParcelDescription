...
@XmlSeeAlso({
    GetCapabilitiesRequestType.class,
    GetParcelIndexRequestType.class,
    GetParcelsByIdRequestType.class,
    GetPersonIndexRequestType.class,
    GetDocumentsRequestType.class
})
